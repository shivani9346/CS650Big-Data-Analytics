...
#printing square roots of all numbers from 1 to 20
for (i in 1:20){
  print(sqrt(i))
}
#creating vectors
...
#printing X and Y
  ...
  Y <- c(X,X,X,X)
  Y
#printing another way to create vector using a range
V <- 1:10
S <- -5:30
T <- 10:1
...
#printing sequence has a nice extra argument by:
B <- seq(1,10, by=2)
B
C <- seq(5, -5, by=-2)
C 
#printing another possible argument length:
